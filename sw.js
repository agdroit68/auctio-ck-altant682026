...
const CACHE = 'auctio-mobile-v6';
const FICHIERS = ['./', './index.html', './xlsx.min.js', './exceljs.min.js', './manifest.webmanifest', './icon-180.png', './icon-512.png', './logo-etude.png', './sceau-etude.png', './communes.js'];
